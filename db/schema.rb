...
ActiveRecord::Schema.define(version: 20150624215520) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "companies", force: :cascade do |t|
    t.string   "name",       default: "The Bronze Yard", null: false
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
  end

  create_table "courses", force: :cascade do |t|
    t.string   "name",        default: "TBA", null: false
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.string   "hire_date",   default: "1/1/1970",      null: false
    t.string   "title",       default: "House Keeping", null: false
  ...
  create_table "locations", force: :cascade do |t|
    t.string   "city",       default: "Tampa", null: false
    t.integer  "company_id"
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end
